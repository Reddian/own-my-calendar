<template>
  <div> <!-- Wrap content in a single root element -->
    ...
    <div class="extension-container">
      ...
      <!-- TODO: Update href when extension link is available -->
      ...
      <div class="extension-screenshot mt-5">
        ...
        <img src="/images/extension-screenshot.png" alt="Chrome Extension Screenshot" class="img-fluid rounded shadow">
      </div>
    </div>
  </div>
</template>
...
<style scoped>
    /* Styles copied from extension.blade.php */
    .page-title {
        /* Assuming .page-title is defined globally or in AppLayout */
    ...
    .step-number {
        ...
        height: 40px;
        border-radius: 50%;
        background-color: var(--primary-purple, #6a1b9a); /* Added fallback color */
        color: white;
        display: flex;
